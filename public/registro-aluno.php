        ...
        <div class="row">
          ...
          <div class="container">
            <div class="row">
              ...
              <?php
              $fotoPath = 'assets/images/profile/photo.jpg';

              include 'assets/include/register-foto.php';
              ?>
              <?php include 'assets/include/register-saude.php'; ?>
              ...
              <?php include 'assets/include/register-escolaridade.php'; ?>

              <div class="text-end">
                <button type="submit" class="btn btn-login">Registrar Aluno</button>
              </div>
            </div>
