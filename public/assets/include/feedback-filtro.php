        ...
        <fieldset>
            <legend class="titulobloco d-flex align-items-center">
                <span class="me-2 d-flex align-items-center">
                    <iconify-icon icon="line-md:search-twotone" class="fs-7 text-muted icone-registro"
            ...
            <div class="row align-items-end">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="professor" class="cadastrotitulo">Aluno</label>
                        <select class="form-control custom-placeholder" id="professor">
                            <option value="">Selecione o Aluno</option>
                            <option value="ana_silva">Ana Silva</option>
                            <option value="bruno_santos">Bruno Santos</option>
                            <option value="carla_pereira">Carla Pereira</option>
                            <option value="diego_martins">Diego Martins</option>
                            <option value="fernanda_gomes">Fernanda Gomes</option>
                            <option value="gustavo_almeida">Gustavo Almeida</option>
                            <option value="isabela_rodrigues">Isabela Rodrigues</option>
                            <option value="lucas_fernandes">Lucas Fernandes</option>
                            <option value="mariana_costa">Mariana Costa</option>
                            <option value="roberto_carvalho">Roberto Carvalho</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="professor" class="cadastrotitulo">Professor</label>
                        <select class="form-control custom-placeholder" id="professor">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="professor" class="cadastrotitulo">Responsável</label>
                        <select class="form-control custom-placeholder" id="professor">
