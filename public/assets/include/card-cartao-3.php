<div class="col-lg-12">
    <div class="card overflow-hidden hover-img">
        ...
        <div class="card-body p-3">
            <span class="badge text-bg-light fs-2 py-1 px-2 lh-sm  mt-3">Prof. José Francisco</span>
            <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="">Produção e Organização de Documentos Técnicos</a>
            <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-2">
                    <i class="ti ti-eye text-dark fs-5"></i>27.654
                </div>

                <div class="d-flex align-items-center fs-2 ms-auto">
                    <i class="ti ti-point text-dark"></i>Qui, Nov 21
                </div>
            </div>
        </div>
    </div>
