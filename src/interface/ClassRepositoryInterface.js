class ClassRepositoryInterface {
    constructor() {
      if (new.target === ClassRepositoryInterface) {
        throw new Error(
          "Não foi possível instanciar ClassRepositoryInterface."
        );
      }
    }
  ...
  module.exports = ClassRepositoryInterface;
